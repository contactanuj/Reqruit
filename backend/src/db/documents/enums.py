...
class OutcomeStatus(StrEnum):
    """
    Tracks post-submission application outcomes.

    Separate from ApplicationStatus (pipeline state). OutcomeStatus captures
    what happened after submission: did the employer view, respond, schedule
    an interview, make an offer, reject, or ghost the applicant?
    """
...
VALID_TRANSITIONS: dict[OutcomeStatus, set[OutcomeStatus]] = {
    ...
    OutcomeStatus.OFFER_RECEIVED: set(),  # terminal
    OutcomeStatus.REJECTED: set(),  # terminal
    OutcomeStatus.GHOSTED: set(),  # terminal
}
