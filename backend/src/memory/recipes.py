...
MEMORY_RECIPES: dict[str, MemoryRecipe] = {
    ...
    # ApplicationOrchestrator assembles tailored resumes from selected blocks.
    # Needs resume context and JD patterns from past applications.
    "application_orchestrator": MemoryRecipe(
        relevance_weight=0.8,
        recency_weight=0.2,
        weaviate_collections=("ResumeChunk", "JobEmbedding"),
        mongodb_collections=("applications",),
        max_results=8,
        hybrid_alpha=0.7,
    ),
}
